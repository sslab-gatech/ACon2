...
python3.7 plots/plot_ps.py --exp_name one_source_USD_ETH_UniswapV2_K_1_beta_0 --y_max_mc 0.5 --step 500
python3.7 plots/plot_ps.py --exp_name two_sources_USD_ETH_UniswapV2_coinbase_K_2_beta_1 --y_max_mc 0.5 --step 500
python3.7 plots/plot_ps.py --exp_name three_sources_USD_ETH_UniswapV2_coinbase_binance_K_3_beta_1 --y_max_mc 0.5 --step 500
